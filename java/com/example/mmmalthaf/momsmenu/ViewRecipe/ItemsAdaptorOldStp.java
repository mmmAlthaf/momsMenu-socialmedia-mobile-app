...
public class ItemsAdaptorOldStp extends BaseAdapter{
    String[] name;
    String[] details;
    //    Integer [] images;
    Context context;
    private static LayoutInflater inflater=null;
    public ItemsAdaptorOldStp(Context mainActivity, String[] prgmNameList, String[] prgmSubList) {
...
//        ImageView img;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        View rowView;
        rowView = inflater.inflate(R.layout.singleitemviewstp, null);
